...
\item Compare ESS to output of target.psrf and tell them whether this is sufficient for convergence. If unsufficient, calculate how many more samples needed.
\end{itemize}
Use
\begin{align*}
\dfrac{n_1}{n_1.eff} \approx \dfrac{n_2}{n_2.eff}
\end{align*}
