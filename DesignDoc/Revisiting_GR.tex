...
\item Add to \texttt{n.eff}. Compare ESS to output of target.psrf and tell them whether this is sufficient for convergence. If unsufficient, calculate how many more samples needed using
